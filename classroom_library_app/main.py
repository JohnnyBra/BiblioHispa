...
class App(ctk.CTk):
    ...
    def initialize_main_app_ui(self):
        ...
        self.leaderboard_tab = self.tab_view.add("🏆 Clasificación") # Translated
    ...
    def setup_manage_loans_tab(self):
        ...
        self.lend_book_button = ctk.CTkButton(lend_frame, text="Prestar Libro", image=lend_icon, font=BUTTON_FONT, command=self.lend_book_ui, corner_radius=8) # Storing the button in an instance variable self.lend_book_button # Translated
    ...
    def refresh_loan_related_combos_and_lists(self):
        ...
        students_in_classroom = student_manager.get_students_by_classroom_db(self.current_leader_classroom) # Students from the selected leader's classroom
